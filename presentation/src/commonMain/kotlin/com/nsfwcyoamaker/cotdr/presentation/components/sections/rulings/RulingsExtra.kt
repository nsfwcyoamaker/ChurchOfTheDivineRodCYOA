...
import com.nsfwcyoamaker.cotdr.resources.section_rulings_extra
...
fun RulingsExtra(
    ...
    TextFlow(
        text = rememberRichTextResource(Res.string.section_rulings_extra),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_rulings_extra),
