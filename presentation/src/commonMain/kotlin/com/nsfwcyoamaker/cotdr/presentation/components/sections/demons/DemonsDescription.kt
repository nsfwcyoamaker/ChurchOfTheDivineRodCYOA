...
import com.nsfwcyoamaker.cotdr.resources.section_demons_description
import com.nsfwcyoamaker.cotdr.resources.section_demons_intro
import org.jetbrains.compose.resources.painterResource

@Composable
fun DemonsDescription(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_demons_description),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_demons_intro),
