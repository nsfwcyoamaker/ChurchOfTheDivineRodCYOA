...
import com.nsfwcyoamaker.cotdr.resources.covenants_intro
import com.nsfwcyoamaker.cotdr.resources.section_covenants_description
import org.jetbrains.compose.resources.painterResource

@Composable
fun CovenantsDescription(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_covenants_description),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.covenants_intro),
