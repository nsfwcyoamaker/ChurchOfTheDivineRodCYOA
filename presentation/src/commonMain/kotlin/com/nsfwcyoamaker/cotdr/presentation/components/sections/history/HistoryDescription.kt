...
import com.nsfwcyoamaker.cotdr.resources.section_history
import com.nsfwcyoamaker.cotdr.resources.section_history_description
...
fun HistoryDescription(
    ...
    TextFlow(
        text = rememberRichTextResource(Res.string.section_history_description),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_history),
