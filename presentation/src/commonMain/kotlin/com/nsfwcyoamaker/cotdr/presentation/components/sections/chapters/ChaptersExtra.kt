...
import com.nsfwcyoamaker.cotdr.resources.section_chapters_extra
...
fun ChaptersExtra(
    ...
    TextFlow(
        text = rememberRichTextResource(Res.string.section_chapters_extra),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_chapters_extra),
