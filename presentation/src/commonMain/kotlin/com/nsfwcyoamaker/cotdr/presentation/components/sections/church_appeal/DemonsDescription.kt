...
import com.nsfwcyoamaker.cotdr.resources.section_church_appeal_description
import com.nsfwcyoamaker.cotdr.resources.section_church_appeal_intro
import org.jetbrains.compose.resources.painterResource

@Composable
fun ChurchAppealDescription(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_church_appeal_description),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_church_appeal_intro),
