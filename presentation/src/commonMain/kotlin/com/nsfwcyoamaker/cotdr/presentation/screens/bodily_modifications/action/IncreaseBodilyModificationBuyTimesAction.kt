...
data class IncreaseBodilyModificationBuyTimesAction(val bodilyModification: BodilyModification): BodilyModificationsSelectionAction {
    override suspend fun execute(
        ...
        dependencies.increaseBodilyModificationBuyTimesUseCase(bodilyModification)
    }
}