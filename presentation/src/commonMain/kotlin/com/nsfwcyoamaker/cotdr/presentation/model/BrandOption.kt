...
enum class BrandOption(
    ...
    Arm(
        ...
        image = null,// TODO missing Res.drawable.brands_arm,
    ),
    Hand(
        choice = Brand.Hand,
        title = Res.string.brands_hand_title,
        description = Res.string.brands_hand_description,
        image = null,// TODO missing Res.drawable.brands_hand,
    ),
    Neck(
        choice = Brand.Neck,
