...
import com.nsfwcyoamaker.cotdr.resources.section_rulings_prelude
...
fun RulingsPrelude(
    ...
    TextFlow(
        text = rememberRichTextResource(Res.string.section_rulings_prelude),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_rulings_prelude),
