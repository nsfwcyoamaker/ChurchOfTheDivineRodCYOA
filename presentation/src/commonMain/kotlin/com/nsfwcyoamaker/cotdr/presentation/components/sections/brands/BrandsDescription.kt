...
import com.nsfwcyoamaker.cotdr.resources.section_brands_description
import com.nsfwcyoamaker.cotdr.resources.section_brands_intro
import org.jetbrains.compose.resources.painterResource

@Composable
fun BrandsDescription(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_brands_description),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_brands_intro),
