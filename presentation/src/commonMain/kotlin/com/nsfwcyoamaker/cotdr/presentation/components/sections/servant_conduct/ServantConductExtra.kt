...
import com.nsfwcyoamaker.cotdr.resources.section_servant_conduct_extra
import org.jetbrains.compose.resources.painterResource

@Composable
fun ServantConductExtra(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_servant_conduct_extra),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_servant_conduct_extra),
