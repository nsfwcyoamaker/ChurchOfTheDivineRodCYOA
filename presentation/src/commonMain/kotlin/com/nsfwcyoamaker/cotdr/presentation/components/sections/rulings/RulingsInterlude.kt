...
import com.nsfwcyoamaker.cotdr.resources.section_rulings_interlude
import org.jetbrains.compose.resources.painterResource

@Composable
fun RulingsInterlude(
    modifier: Modifier = Modifier,
) {
    TextFlow(
        text = rememberRichTextResource(Res.string.section_rulings_interlude),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.section_rulings_interlude),
