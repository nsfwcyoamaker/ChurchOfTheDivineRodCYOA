...
import com.nsfwcyoamaker.cotdr.resources.covenants_extra
...
fun CovenantsExtra(
    ...
    TextFlow(
        text = rememberRichTextResource(Res.string.covenants_extra),
        modifier = modifier,
        ...
        component = {
            Image(
                painter = painterResource(Res.drawable.covenants_extra),
...
@Composable
private fun CovenantsExtraPreview() {
    AppScope {
        CovenantsExtra()
    }
}